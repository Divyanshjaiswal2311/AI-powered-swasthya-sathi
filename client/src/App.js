...
// ThemeProvider available via "./contexts/ThemeContext" if needed
...
// Health feature pages
import HealthProfile from "./pages/Health/HealthProfile";   // Comprehensive health profile
import AIHealthChat from "./pages/Health/AIHealthChat";     // AI health assistant
import EmergencyAlert from "./pages/Health/EmergencyAlert"; // Emergency alert system
import FeaturesDashboard from "./pages/FeaturesDashboard";  // Features showcase dashboard
import HealthMetrics from "./pages/HealthMetrics";          // Health metrics tracking
import MedicalRecords from "./pages/MedicalRecords";        // Medical records management
  ...
  return (
    <ErrorBoundary>
      <>
        ...
        {/* Features Dashboard - Showcase all features */}
        <Route
          path="/features"
          element={
            <ProtectedRoute>
